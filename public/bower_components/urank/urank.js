...
var enterLog = function(value){
    ...
    var scriptURL = "http://itic.uncu.edu.ar:8880/riskID_only_prediction/server/log.php",
        date = new Date(),
        ...
        urankState = sessionId + ',' + userName +',' + userToken + ',' + timestamp+','+value + ', prediction add-on',
   ...
   /* var MISC2 = {
    ...
    var MISC = {
        ...
        saveLabeling: function(){
            //var scriptURL = "http://localhost/loginapp/server/log.php",
            var scriptURL = "http://itic.uncu.edu.ar:8880/riskID_only_prediction/server/save.php",
                date = new Date(),
                timestamp = date.getFullYear() + '-' + (parseInt(date.getMonth()) + 1) + '-' + date.getDate() + '_' + date.getHours() + '.' + date.getMinutes() + '.' + date.getSeconds(),
